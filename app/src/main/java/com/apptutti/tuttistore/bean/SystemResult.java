...
public class SystemResult{
    ...
    public static class ChildrenBean implements Serializable{
        ...
        public String toString(){
            return "ChildrenBean{" + "courseId=" + courseId + ", id=" + id + ", name='" + name + '\'' + ", order=" + order + ", parentChapterId=" + parentChapterId + ", userControlSetTop=" + userControlSetTop + ", visible=" + visible + ", children=" + children + '}';
        }
    }
}
