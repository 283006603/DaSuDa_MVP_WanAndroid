package com.apptutti.tuttistore.http;

import android.net.ParseException;
import android.util.Log;
import android.widget.Toast;

import com.apptutti.tuttistore.base.BaseApplication;
...
public class ExceptionHandler {
    ...
    public static void handleException(Throwable e) {
        ...
        Toast.makeText(BaseApplication.getInstance(), errmsg, Toast.LENGTH_LONG).show();
    }
